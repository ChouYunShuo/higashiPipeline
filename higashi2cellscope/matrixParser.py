...
class MatrixParser:
    def __init__(self, impute_dir, raw_dir, chrom_list, chrom_offset, cell_id, neighbors, res, cytoband_path, embedding_name="exp1", process_cnt=1, is_raw=False):
    ...
    def __iter__(self):
        ...
        for idx in range_iter:
            ...
            if self.is_raw:
                cell_coo_origin = origin_sparse[self.cell_id].tocoo()
